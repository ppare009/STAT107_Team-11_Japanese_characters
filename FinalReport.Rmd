---
title: "An Investigation of the Distributions of Hiragana, Katakana, and Kanji in Japanese Texts"
author: "Pankshi Parekar, Isabella Perez, and Ulices Ramirez Lopez"
output:
...
## Introduction
  ...
  This analysis may benefit translators, linguists, and language learners. As it offers factual data on writing system usage in Japanese literature. In terms of methodology, we are performing a comparative analysis by sampling and classifying characters in each test according to their writing system. This allows us to classify and compare patterns in the writing system, providing a clear image of how different types of text utilize Hiragana, Katakana, Kanji.
