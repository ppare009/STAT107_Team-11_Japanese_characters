...
This process was repeated for every novel in our sample. The Host Website, total number of characters, total number of Hiragana, Katakana, and Kanji in each novel, etc. was saved in the the following table`jp_novels.csv`. A snippet of this table is provided below:
