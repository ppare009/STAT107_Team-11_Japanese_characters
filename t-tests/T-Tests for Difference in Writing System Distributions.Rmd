...
Finally, one should check the variances of the log-transformed data. 
...
```{r hira_kata}
t.test(log_hiragana, log_katakana, alternative = "two.sided", 
...
```{r hira_kanji}
t.test(log_hiragana, log_kanji, alternative = "two.sided", 
       mu = 0, conf.level = 0.95)
...
```{r kata_kanji}
t.test(log_katakana, log_kanji, alternative = "two.sided",
       mu = 0, conf.level = 0.95)
